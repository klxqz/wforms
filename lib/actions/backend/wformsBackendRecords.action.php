 ...
 * 
 * Processes requests in backend at URL wforms/?action=records
 ...
 * 
 * Доступен в бэкенде по урлу wforms/?action=records
 * Подробнее о маршрутизации в бэкенде:
 * http://www.webasyst.com/ru/framework/docs/dev/backend-routing/
 */
class wformsBackendRecordsAction extends waViewAction
{
	/**
