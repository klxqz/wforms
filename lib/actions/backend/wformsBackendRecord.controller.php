 ...
 * 
 * Processes requests in backend at URL wforms/?action=record&id=[ID]
 ...
 * 
 * Доступен в бэкенде по урлу wforms/?action=record&id=[ID]
 * Подробнее о маршрутизации в бэкенде:
 * http://www.webasyst.com/ru/framework/docs/dev/backend-routing/
 */
class wformsBackendRecordController extends waJsonController
{
